<template>
  <div class="ChinaCard">
    ...
    <div class="chinaDataTable">
      ...
      <span class="chinaDableSpan">较昨日{{ allData.data.add_daily.jwsrNum }}</span>
      <span class="chinaDableSpan">较昨日{{ allData.data.add_daily.asymptomNum }}</span>
      <span class="chinaDableSpan">较昨日{{ allData.data.add_daily.heconNum }}</span>
