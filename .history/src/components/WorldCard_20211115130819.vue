  ...
  <div class="four-container">
    <div class="WorldCard">
      ...
      <div class="worldDataTable">
        ...
        <span class="worldDableSpan itemData">{{Math.round(allData.data.othertotal.certain/10000)
        }}万</span>
        <span class="worldDableSpan itemData">{{
           Math.round(allData.data.othertotal.die/10000)
        }}万</span>
        <span class="worldDableSpan itemData">{{
          Math.round(allData.data.othertotal.recure/10000)
        }}万</span>
