...
export default {
  ...
  methods: {
    myJsonp(){
      var url = "https://news.sina.com.cn/project/fymap/ncp2020_full_data.json"
      let domScript = document.createElement("script")
      domScript.src= url;
      domScript.type = "text/javascript"
      document.getElementsByTagName("body")[0].appendChild(domScript)
      window['getJsonp'] = this.initData
    }
    ...
    initData() {
      ...
      // });
      this.$jsonp("https://news.sina.com.cn/project/fymap/ncp2020_full_data.json",{
