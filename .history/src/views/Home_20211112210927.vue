...
export default {
  ...
  methods: {
    initData() {
      ...
      // });
      // this.$jsonp("https://news.sina.com.cn/project/fymap/ncp2020_full_data.json",null,(err,data)=>{
      //   this.allData = data.data;
      // });

// this.$http.get('https://news.sina.com.cn/project/fymap/ncp2020_full_data.json').then(response => {
...
//           {
//             jsonp: "jsoncallback", //jsonp默认是callback,百度缩写成了cb，所以需要指定下                     }
//           }
//         )
//         .then((res) => {
//           console.log(res);
