  ...
  <div class="home" v-if="allData.data">
    ...
    <el-row>
      <el-col :span="6">
        ...
        <br />
        <LineChart :chartData="allData.data.otherhistorylist" height="30vh"></LineChart>
      ...
      <el-col :span="6">
        ...
        <br />
        <GradientLineChart :chartData="allData.data.historylist" height="30vh"></GradientLineChart>
        <br />
...
export default {
  ...
  methods: {
    initData() {
      ...
      tshi.$jsonp("https://news.sina.com.cn/project/fymap/ncp2020_full_data.json", null, (err, data) => {
   if (err) {
